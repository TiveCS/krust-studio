...
## Corpus Check
- 179 files · ~136,686 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1513 nodes · 2571 edges · 151 communities (123 shown, 28 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 156 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5dc86c65`
...
8. `RedisDriver` - 22 edges
9. `withRetry()` - 22 edges
10. `PostgresDriver` - 19 edges
...
- `SubTab()` --calls--> `cn()`  [INFERRED]
  krust-studio-app/src/renderer/src/components/RoutineView.tsx → krust-studio-app/src/renderer/src/lib/utils.ts
...
Cohesion: 0.15
Nodes (34): isConnectionFatal(), RedisDriver, cancelQuery(), countRows(), createDriver(), currentDatabase(), describeTable(), disconnectSession() (+26 more)

### Community 1 - "tsx ConnectionSwitcher"
Cohesion: 0.15
Nodes (10): RenameTableDialog(), Props, DIALECTS, Props, SqlEditor, SqlEditorHandle, LIMITS, StructureEditor() (+2 more)
...
Cohesion: 0.08
Nodes (24): AppSidebar(), sqlitePlanNode(), CAPABILITIES, capabilitiesFor(), CreateTableSpec, EntityInfo, EntityType, EnumType (+16 more)
...
Cohesion: 0.07
Nodes (27): Window, BackupApi, BackupResult, CaptureInput, ConnectionsApi, ConnectionWorkspace, DialogApi, DriverCapabilities (+19 more)
...
Cohesion: 0.06
Nodes (35): DriverCore, KeyValueCapable, ADD_VERBS, asBuf(), buildConflict(), classifyConflict(), Client, decodeMember() (+27 more)
...
Cohesion: 0.32
Nodes (8): Props, buildOrderBy(), buildWhere(), buildWhereClause(), quoteIdent(), Filter, RowsResult, Sort
...
Cohesion: 0.28
Nodes (19): classifyStatement(), alterTable(), applyChanges(), captureAll(), connectSession(), createIndex(), createRoutine(), createTable() (+11 more)
...
Cohesion: 0.15
Nodes (7): DbDriver, defaultIndexName(), quoteIdent(), SqliteDriver, EntityRef, IndexSpec, ReferencingTable
...
Cohesion: 0.07
Nodes (28): Data, ExportDialog(), Format, Props, Scope, FilterBar(), Group, OPS (+20 more)
...
Cohesion: 0.11
Nodes (30): buildCreateTable(), fkActionClause(), routineArgLiteral(), dropDefault(), extractColumnDef(), insertBefore(), positionClause(), spliceDefault() (+22 more)
...
Cohesion: 0.16
Nodes (9): classifyParam(), ParamCtl, ParamField(), SubTab(), SubView, bareTypeName(), enumForType(), enumValues() (+1 more)
...
Cohesion: 0.13
Nodes (23): buildDelete(), buildInsert(), buildSearch(), buildUpdate(), FK_ACTIONS, renderSql(), RoutineCapable, safePaging() (+15 more)
...
Cohesion: 0.19
Nodes (12): ConnectionForm(), DEFAULT_PORTS, emptyValues(), FormValues, Props, schema, toFormValues(), Deps (+4 more)
...
Cohesion: 0.22
Nodes (18): activeKey(), assignEntries(), buildChangesetSql(), clearHistory(), createChangeset(), deleteChangeset(), deleteEntries(), getActiveId() (+10 more)
...
Cohesion: 0.15
Nodes (6): CommandPalette(), DataGrid(), DateEditKind, Sel, UiState, useUi

### Community 122 - "Community 122"
Cohesion: 0.20
Nodes (7): CreatableType, RedisAddKeyDialog(), TYPES, RedisKeyView(), RedisSidebar(), TYPE_BADGE, useRedis
...
Cohesion: 0.13
Nodes (14): Backend, beta.3 pass (compiles + builds, not live-tested), Capability refactor (ADR-0020), Commits on feat/v1.7.0 (this pass), Done (compiles + builds), Functional gaps 1–5 — DONE (second pass; compiles + builds, not live-tested), Known gaps / deliberate simplifications (remaining beta follow-ups), Live TTL countdown (+6 more)
...
Cohesion: 0.13
Nodes (15): api, BackupSpec, HistoryQuery, HistoryStream, ReadValueOpts, RedisCommitBatch, RoutineArg, SaveConnectionInput (+7 more)
...
Cohesion: 0.26
Nodes (12): BackupProgress, fkGuards(), pgArrayBody(), quoteIdent(), restorePreview(), restoreRun(), runBackup(), sqlLiteral() (+4 more)

### Community 132 - "Community 132"
Cohesion: 0.38
Nodes (11): decryptPassword(), duplicateConnection(), encryptPassword(), getStoredPassword(), listConnections(), readStore(), removeConnection(), saveConnection() (+3 more)
...
Cohesion: 0.47
Nodes (7): getDataDir(), templatesFile(), listTemplates(), readStore(), removeTemplate(), saveTemplate(), writeStore()
...
Cohesion: 0.60
Nodes (5): testConnection(), testMysql(), testPostgres(), testRedis(), testSqlite()
...
## Knowledge Gaps
- **559 isolated node(s):** `1.7.0 beta release — IN PROGRESS`, `beta.1 — browse / execute / create+drop — BUILT (2026-07-02, typecheck + build green; not yet live-tested)`, `beta.2 — MySQL safe replacement`, `P0 — next: inline filter builder + raw WHERE — DONE`, `v1.3.4 — fix (data-loss feel) — DONE (merged 69c7791, manually verified)` (+554 more)
...
- **Why does `cn()` connect `utils sidebar` to `tsx CommandPalette`, `applyChanges driver`, `Community 143`, `Community 144`, `context menu`, `dropdown menu`, `Community 152`, `dialog tsx`, `sheet tsx`, `command tsx`, `Community 35`, `popover tsx`, `Community 60`, `alert tsx`, `tooltip tsx`, `TitleBar tsx`, `Community 82`, `mobile useIsMobile`, `button tsx`, `combobox tsx`, `checkbox tsx`, `input tsx`, `separator tsx`, `skeleton tsx`, `Community 108`, `Community 126`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `AppSidebar()` connect `applyChanges driver` to `Community 118`, `utils sidebar`?**
