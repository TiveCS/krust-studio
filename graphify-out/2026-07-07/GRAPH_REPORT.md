...
## Corpus Check
- 180 files · ~140,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1529 nodes · 2592 edges · 149 communities (122 shown, 27 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 155 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `beea2255`
...
- `Database Switching` --conceptually_related_to--> `ADR-0010 Optional Database & Switching`  [INFERRED]
  CONTEXT.md → docs/adr/0010-optional-database-and-switching.md
- `Table Editor` --cites--> `ADR-0002 Captured DDL Changesets, No Squash`  [EXTRACTED]
  CONTEXT.md → docs/adr/0002-captured-ddl-changesets-no-squash.md
- `Table Editor` --cites--> `ADR-0011 Column Reordering & Unified MySQL MODIFY`  [EXTRACTED]
  CONTEXT.md → docs/adr/0011-column-reordering-and-unified-mysql-modify.md
...
Cohesion: 0.06
Nodes (93): BackupProgress, fkGuards(), pgArrayBody(), quoteIdent(), restorePreview(), restoreRun(), runBackup(), sqlLiteral() (+85 more)
...
Cohesion: 0.05
Nodes (51): AppSidebar(), api, Window, CAPABILITIES, capabilitiesFor(), BackupApi, BackupResult, BackupSpec (+43 more)
...
Cohesion: 0.16
Nodes (14): Props, buildOrderBy(), buildWhere(), buildWhereClause(), safePaging(), readRows(), PostgresDriver, quoteIdent() (+6 more)
...
Cohesion: 0.13
Nodes (6): DbDriver, quoteIdent(), SqliteDriver, IndexSpec, ReferencingTable, SchemaOp
...
Cohesion: 0.08
Nodes (23): FilterBar(), Group, OPS, Row, seed(), classify(), FkExpand(), JsonValue() (+15 more)
...
Cohesion: 0.11
Nodes (28): buildSearch(), fkActionClause(), routineArgLiteral(), dropDefault(), extractColumnDef(), insertBefore(), positionClause(), spliceDefault() (+20 more)
...
Cohesion: 0.10
Nodes (27): buildCreateTable(), buildDelete(), buildInsert(), buildUpdate(), defaultIndexName(), DriverDeps, FK_ACTIONS, renderSql() (+19 more)
...
Cohesion: 0.15
Nodes (7): ConnectionSwitcher(), DRIVER_LABEL, DatabaseSwitcher(), TabBar(), VIEWS, ViewSwitch(), useConnections
...
## Knowledge Gaps
- **568 isolated node(s):** `Core principle`, `Redis Key`, `Routine`, `Routine Recovery Copy`, `Find (Data Grid)` (+563 more)
...
- **Why does `cn()` connect `utils sidebar` to `tsx CommandPalette`, `DbDriver quoteIdent`, `Community 143`, `context menu`, `dropdown menu`, `Community 152`, `dialog tsx`, `sheet tsx`, `command tsx`, `Community 35`, `popover tsx`, `Community 60`, `Community 67`, `alert tsx`, `tooltip tsx`, `TitleBar tsx`, `Community 82`, `mobile useIsMobile`, `button tsx`, `combobox tsx`, `checkbox tsx`, `input tsx`, `separator tsx`, `skeleton tsx`, `Community 108`, `Community 121`, `Community 126`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `AppSidebar()` connect `DbDriver quoteIdent` to `Community 118`, `utils sidebar`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `EntityRef` connect `PostgresDriver connect` to `readStore writeStore`, `Community 129`, `ExportDialog tsx`, `DbDriver quoteIdent`, `Community 76`, `Community 110`, `connections ConnectionWorkspace`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
...
- **What connects `Core principle`, `Redis Key`, `Routine` to the rest of the system?**
