...
## Corpus Check
- 188 files · ~146,380 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1608 nodes · 2796 edges · 153 communities (124 shown, 29 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 161 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6ec2a83e`
...
5. `getConnectionConfig()` - 30 edges
...
- `ProposalCard()` --calls--> `useConnections`  [INFERRED]
  krust-studio-app/src/renderer/src/components/SchemaSyncView.tsx → krust-studio-app/src/renderer/src/store/connections.ts
- `OpBlock()` --calls--> `cn()`  [INFERRED]
  krust-studio-app/src/renderer/src/components/SchemaSyncView.tsx → krust-studio-app/src/renderer/src/lib/utils.ts
...
Cohesion: 0.06
Nodes (99): BackupProgress, fkGuards(), pgArrayBody(), quoteIdent(), restorePreview(), restoreRun(), runBackup(), sqlLiteral() (+91 more)

### Community 1 - "tsx ConnectionSwitcher"
Cohesion: 0.10
Nodes (12): RenameTableDialog(), Props, DIALECTS, Props, SqlEditor, SqlEditorHandle, LIMITS, StructureEditor() (+4 more)
...
Cohesion: 0.14
Nodes (3): DriverCore, RedisDriver, RedisScanResult
...
Cohesion: 0.12
Nodes (29): FkInlinePicker(), McpSettings(), cn(), Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter() (+21 more)

### Community 8 - "DbDriver quoteIdent"
Cohesion: 0.06
Nodes (35): api, BackupApi, BackupResult, BackupSpec, ConnectionsApi, ConnectionWorkspace, DialogApi, HistoryApi (+27 more)
...
Cohesion: 0.09
Nodes (19): AppSidebar(), sqlitePlanNode(), capabilitiesFor(), EntityType, EnumType, QueryPlan, QueryResult, RedisKeyType (+11 more)
...
Cohesion: 0.08
Nodes (21): FilterBar(), Group, OPS, Row, seed(), classifyParam(), ParamCtl, ParamField() (+13 more)
...
Cohesion: 0.20
Nodes (10): Data, ExportDialog(), Format, Props, Scope, buildSearch(), safePaging(), searchRows() (+2 more)
...
Cohesion: 0.12
Nodes (26): fkActionClause(), routineArgLiteral(), dropDefault(), extractColumnDef(), insertBefore(), positionClause(), spliceDefault(), spliceNullable() (+18 more)
...
Cohesion: 0.11
Nodes (26): buildCreateTable(), buildDelete(), buildInsert(), buildUpdate(), DriverDeps, FK_ACTIONS, renderSql(), RoutineCapable (+18 more)
...
Cohesion: 0.28
Nodes (11): Props, buildOrderBy(), buildWhere(), buildWhereClause(), readRows(), EntityRef, Filter, RowsResult (+3 more)

### Community 122 - "Community 122"
Cohesion: 0.17
Nodes (7): CommandPalette(), CreatableType, RedisAddKeyDialog(), TYPES, RedisSidebar(), TYPE_BADGE, useRedis
...
Cohesion: 0.22
Nodes (7): OpBlock(), ProposalCard(), SchemaSyncView(), SchemaSyncCommitResult, SchemaSyncProposal, SchemaSyncState, useSchemaSync
...
Cohesion: 0.08
Nodes (39): setupAutoUpdater(), registerIpc(), bearer(), buildServer(), handle(), mcpServerStatus(), readBody(), sendJson() (+31 more)
...
## Knowledge Gaps
- **579 isolated node(s):** `SqlCapable`, `TabularCapable`, `TabularMutCapable`, `SchemaMutCapable`, `FK_ACTIONS` (+574 more)
...
- **Why does `cn()` connect `utils sidebar` to `Community 129`, `tsx CommandPalette`, `Community 132`, `Community 143`, `context menu`, `dropdown menu`, `Community 152`, `dialog tsx`, `sheet tsx`, `command tsx`, `Community 35`, `popover tsx`, `Community 53`, `Community 60`, `Community 67`, `alert tsx`, `tooltip tsx`, `TitleBar tsx`, `Community 82`, `mobile useIsMobile`, `button tsx`, `combobox tsx`, `checkbox tsx`, `input tsx`, `separator tsx`, `skeleton tsx`, `Community 108`, `Community 126`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `useConnections` connect `Community 118` to `tsx ConnectionSwitcher`, `Community 129`, `tsx CommandPalette`, `Community 27`, `Community 108`, `MysqlDriver alterTable`, `connections ConnectionWorkspace`, `Community 117`, `Community 53`, `Community 149`, `BackupDialog tsx`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `RedisDriver` connect `applyChanges driver` to `readStore writeStore`, `Community 117`, `enums bareTypeName`, `Community 141`?**
...
- **What connects `SqlCapable`, `TabularCapable`, `TabularMutCapable` to the rest of the system?**
