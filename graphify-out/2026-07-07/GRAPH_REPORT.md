...
## Summary
- 1636 nodes · 2858 edges · 156 communities (124 shown, 32 thin omitted)
...
Cohesion: 0.13
Nodes (52): classifyStatement(), isConnectionFatal(), alterTable(), applyChanges(), cancelQuery(), captureAll(), connectSession(), countRows() (+44 more)
...
Cohesion: 0.07
Nodes (35): api, Window, BackupApi, BackupSpec, Changeset, ConnectionsApi, DialogApi, HistoryApi (+27 more)
...
Cohesion: 0.16
Nodes (13): commitProposal(), createKey(), dismissProposal(), exportProposalSql(), listProposals(), liveShape(), pending, ProposeInput (+5 more)

### Community 40 - "JsonViewerPanel tsx"
Cohesion: 0.12
Nodes (11): AppSidebar(), OpBlock(), ProposalCard(), SchemaSyncView(), CAPABILITIES, capabilitiesFor(), DriverCapabilities, SchemaSyncCommitResult (+3 more)
...
Cohesion: 0.13
Nodes (25): buildSearch(), fkActionClause(), routineArgLiteral(), safePaging(), positionClause(), alterTable(), connect(), countRows() (+17 more)
...
Cohesion: 0.12
Nodes (20): ConnectionWorkspace, EntityInfo, EntityType, EnumType, QueryPlan, QueryResult, RedisKeyType, RoutineInfo (+12 more)
...
Cohesion: 0.10
Nodes (36): buildCreateTable(), buildOrderBy(), buildWhere(), buildWhereClause(), DbDriver, defaultIndexName(), DriverCore, FK_ACTIONS (+28 more)
...
Cohesion: 0.14
Nodes (12): Data, ExportDialog(), Format, Props, Scope, FkInlinePicker(), Props, formatRows() (+4 more)
