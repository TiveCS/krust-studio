...
## Corpus Check
- 192 files · ~150,354 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1639 nodes · 2871 edges · 162 communities (131 shown, 31 thin omitted)
...
4. `getConnectionConfig()` - 34 edges
5. `SqliteDriver` - 31 edges
6. `useConnections` - 25 edges
7. `Changelog` - 25 edges
8. `RedisDriver` - 23 edges
9. `withRetry()` - 23 edges
10. `PostgresDriver` - 20 edges
...
Cohesion: 0.14
Nodes (34): classifyStatement(), isConnectionFatal(), RedisDriver, bulkIntrospect(), cancelQuery(), countRows(), currentDatabase(), disconnectSession() (+26 more)

### Community 1 - "tsx ConnectionSwitcher"
Cohesion: 0.25
Nodes (4): DIALECTS, Props, SqlEditor, SqlEditorHandle
...
Cohesion: 0.13
Nodes (8): DbDriver, defaultIndexName(), quoteIdent(), SqliteDriver, EntityRef, IndexSpec, ReferencingTable, TableStructure
...
Cohesion: 0.13
Nodes (4): DriverCore, KeyValueCapable, RedisDriver, RedisScanResult

### Community 6 - "codemirror react"
Cohesion: 0.06
Nodes (35): dependencies, class-variance-authority, clsx, cluster-key-slot, cmdk, codemirror, @codemirror/autocomplete, @codemirror/commands (+27 more)
...
Cohesion: 0.05
Nodes (50): api, Window, CAPABILITIES, BackupApi, CaptureInput, ConnectionsApi, ConnectionWorkspace, CreateTableSpec (+42 more)
...
Cohesion: 0.10
Nodes (32): AI Access Audit, AI Read Allowlist, Backup, Captured DDL, Changeset, Command Palette, Data Location, Destructive (history tag) (+24 more)

### Community 13 - "MysqlDriver alterTable"
Cohesion: 0.15
Nodes (15): RedisCommand, RedisDbInfo, RedisKeyInfo, buildCommands(), buildCreateCommands(), cmd(), doCommit(), EMPTY_LIST (+7 more)
...
Cohesion: 0.21
Nodes (12): ADR-0002 Captured DDL Changesets, No Squash, ADR-0011 Column Reordering & Unified MySQL MODIFY, Staged Edits, Architecture, Built (working), Dev loop, Gaps — prioritized TODO, Krust Studio Handover (+4 more)
...
Cohesion: 0.20
Nodes (20): HistoryQuery, activeKey(), assignEntries(), buildChangesetSql(), capture(), clearHistory(), createChangeset(), deleteChangeset() (+12 more)
...
Cohesion: 0.12
Nodes (19): alterTable(), describeTable(), listEntities(), previewAlter(), introspectSchema(), addProposal(), commitProposal(), createKey() (+11 more)

### Community 40 - "JsonViewerPanel tsx"
Cohesion: 0.18
Nodes (9): AppSidebar(), OpBlock(), ProposalCard(), SchemaSyncView(), capabilitiesFor(), SchemaSyncCommitResult, SchemaSyncProposal, SchemaSyncState (+1 more)
...
Cohesion: 0.20
Nodes (9): ADR-0012 Tab-centric Persistent Workspace, 15. Configurable, scope-aware keybindings via a command registry, Amendments, Consequences, Context, Decision, Status, Table Editor (+1 more)
...
Cohesion: 0.16
Nodes (12): FilterBar(), Group, OPS, Row, seed(), appendCellCondition(), filtersToWhere(), quoteIdent() (+4 more)
...
Cohesion: 0.19
Nodes (14): BackupProgress, fkGuards(), pgArrayBody(), quoteIdent(), restorePreview(), runBackup(), sqlLiteral(), target() (+6 more)

### Community 68 - "enums bareTypeName"
Cohesion: 0.17
Nodes (13): ADD_VERBS, asBuf(), Client, decodeMember(), emptiesCollection(), isValidUtf8(), REMOVAL_VERBS, verbOf() (+5 more)
...
Cohesion: 0.11
Nodes (31): buildCreateTable(), buildSearch(), fkActionClause(), routineArgLiteral(), dropDefault(), extractColumnDef(), insertBefore(), positionClause() (+23 more)
...
Cohesion: 0.32
Nodes (17): restoreRun(), applyChanges(), captureAll(), connectSession(), createDriver(), createIndex(), createRoutine(), createTable() (+9 more)

### Community 108 - "Community 108"
Cohesion: 0.28
Nodes (11): Props, buildOrderBy(), buildWhere(), buildWhereClause(), safePaging(), readRows(), ColumnInfo, Filter (+3 more)

### Community 110 - "Community 110"
Cohesion: 0.11
Nodes (25): buildDelete(), buildInsert(), buildUpdate(), DriverDeps, FK_ACTIONS, renderSql(), RoutineCapable, SchemaMutCapable (+17 more)
...
Cohesion: 0.09
Nodes (35): ConnectionForm(), DEFAULT_PORTS, emptyValues(), FormValues, Props, schema, toFormValues(), testConnection() (+27 more)

### Community 119 - "Community 119"
Cohesion: 0.33
Nodes (5): 22. MCP Schema Sync: AI proposes staged schema ops, never writes the DB, Consequences, Context, Decision, Status
...
Cohesion: 0.50
Nodes (4): emitError(), forward(), headers, rl

### Community 122 - "Community 122"
Cohesion: 0.15
Nodes (10): CommandPalette(), DatabaseSwitcher(), CreatableType, RedisAddKeyDialog(), TYPES, RedisKeyView(), RedisSidebar(), TYPE_BADGE (+2 more)
...
Cohesion: 0.06
Nodes (53): McpSettings(), readRows(), setupAutoUpdater(), registerIpc(), describeAllowedTable(), findEntry(), listAllowedTables(), readAllowedRows() (+45 more)
...
Cohesion: 0.24
Nodes (6): addr(), buildConflict(), classifyConflict(), normalizeType(), RedisCommitBatch, RedisCommitResult

### Community 144 - "Community 144"
Cohesion: 0.33
Nodes (6): Data, ExportDialog(), Format, Props, Scope, SearchResult
...
Cohesion: 0.28
Nodes (4): NewTableEditor(), TYPES, QueryView(), TableTabView()

### Community 149 - "Community 149"
Cohesion: 0.20
Nodes (5): DataGrid(), DateEditKind, Sel, UiState, useUi
...
Cohesion: 0.25
Nodes (7): Config + audit (phase 3 + 4), Done (compiles + builds), MCP Server + AI Schema Sync — Implementation Status (1.7.0), Not yet done / follow-ups, Schema Sync (phase 2), Server + transport (phase 1 + 5), Tools
...
Cohesion: 0.40
Nodes (3): RenameTableDialog(), Props, DriverType
...
Cohesion: 0.60
Nodes (4): EMPTY, loadWorkspace(), saveWorkspace(), workspacePath()
...
- **Why does `cn()` connect `utils sidebar` to `Community 134`, `Community 143`, `Community 144`, `context menu`, `dropdown menu`, `Community 151`, `Community 152`, `Community 154`, `Community 155`, `dialog tsx`, `sheet tsx`, `command tsx`, `Community 35`, `JsonViewerPanel tsx`, `popover tsx`, `Community 53`, `Community 60`, `alert tsx`, `tooltip tsx`, `TitleBar tsx`, `mobile useIsMobile`, `button tsx`, `combobox tsx`, `checkbox tsx`, `input tsx`, `separator tsx`, `skeleton tsx`, `Community 123`, `Community 126`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `useConnections` connect `Community 122` to `Community 160`, `Community 161`, `Community 129`, `JsonViewerPanel tsx`, `Community 27`, `DbDriver quoteIdent`, `connections ConnectionWorkspace`, `Community 146`, `Community 117`, `Community 118`, `Community 149`, `BackupDialog tsx`, `Community 154`, `Community 123`, `Community 156`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `EntityRef` connect `tsx CommandPalette` to `readStore writeStore`, `Community 67`, `Community 132`, `DbDriver quoteIdent`, `Community 108`, `Community 76`, `Community 110`, `connections ConnectionWorkspace`, `Community 156`?**
