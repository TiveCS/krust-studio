...
## Corpus Check
- 189 files · ~147,351 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1616 nodes · 2828 edges · 150 communities (121 shown, 29 thin omitted)
...
4. `getConnectionConfig()` - 32 edges
...
Cohesion: 0.05
Nodes (55): AppSidebar(), api, Window, CAPABILITIES, capabilitiesFor(), BackupApi, BackupResult, ConnectionsApi (+47 more)
...
Cohesion: 0.24
Nodes (3): RoutineCapable, PostgresDriver, TableStructure
...
Cohesion: 0.11
Nodes (28): buildCreateTable(), fkActionClause(), routineArgLiteral(), dropDefault(), extractColumnDef(), insertBefore(), positionClause(), spliceDefault() (+20 more)
...
Cohesion: 0.11
Nodes (23): buildDelete(), buildInsert(), buildUpdate(), DriverDeps, FK_ACTIONS, renderSql(), SchemaMutCapable, SQL_OP (+15 more)
...
Cohesion: 0.14
Nodes (9): DatabaseSwitcher(), NewTableEditor(), TYPES, QueryView(), TabBar(), TableTabView(), VIEWS, ViewSwitch() (+1 more)
...
Cohesion: 0.22
Nodes (15): FkInlinePicker(), Props, buildOrderBy(), buildSearch(), buildWhere(), buildWhereClause(), safePaging(), readRows() (+7 more)
...
Cohesion: 0.07
Nodes (47): McpSettings(), setupAutoUpdater(), registerIpc(), describeAllowedTable(), findEntry(), listAllowedTables(), readAllowedRows(), requireDataReads() (+39 more)
...
- **Why does `cn()` connect `utils sidebar` to `Community 129`, `tsx CommandPalette`, `Community 132`, `Community 134`, `DbDriver quoteIdent`, `Community 143`, `context menu`, `dropdown menu`, `Community 152`, `dialog tsx`, `sheet tsx`, `command tsx`, `Community 35`, `JsonViewerPanel tsx`, `popover tsx`, `Community 53`, `Community 60`, `Community 67`, `alert tsx`, `tooltip tsx`, `TitleBar tsx`, `mobile useIsMobile`, `button tsx`, `combobox tsx`, `checkbox tsx`, `input tsx`, `separator tsx`, `skeleton tsx`, `Community 108`, `Community 121`, `Community 126`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `useConnections` connect `Community 118` to `tsx ConnectionSwitcher`, `Community 129`, `tsx CommandPalette`, `DbDriver quoteIdent`, `Community 27`, `Community 108`, `MysqlDriver alterTable`, `connections ConnectionWorkspace`, `Community 82`, `Community 117`, `Community 149`, `BackupDialog tsx`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `EntityRef` connect `Community 121` to `readStore writeStore`, `tsx ConnectionSwitcher`, `ExportDialog tsx`, `DbDriver quoteIdent`, `Community 76`, `Community 110`, `connections ConnectionWorkspace`, `PostgresDriver connect`?**
